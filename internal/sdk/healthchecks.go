...
// Healthchecks - Healthcheck endpoints
...
func newHealthchecks(rootSDK *Semva, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Healthchecks {
	return &Healthchecks{
		rootSDK:          rootSDK,
...
// ReadRoot - Read Root
func (s *Healthchecks) ReadRoot(ctx context.Context, opts ...operations.Option) (*operations.ReadRootResponse, error) {
	...
	res := &operations.ReadRootResponse{
...
// ReadHealth - Read Health
func (s *Healthchecks) ReadHealth(ctx context.Context, opts ...operations.Option) (*operations.ReadHealthResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
		operations.SupportedOptionSkipDeserialization,
	...
	res := &operations.ReadHealthResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
