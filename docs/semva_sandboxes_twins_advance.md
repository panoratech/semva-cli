...
```
semva sandboxes twins advance [flags]
```

### Examples

```
  semva sandboxes-twins advance --sandbox-id 0e5430b8-577a-40fb-a158-9fc5ad75ab04 --sandbox-twin-id 10a63cd8-60d5-4c91-bbd5-7c17aa12a3d7
```
