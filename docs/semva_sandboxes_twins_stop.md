...
```
semva sandboxes twins stop [flags]
```

### Examples

```
  semva sandboxes-twins stop --sandbox-id c596993f-a7ba-4c8f-a8ef-12fa7483b957 --sandbox-twin-id 2bc8e24b-4bd7-43d3-88b9-1466c640d1d1
```
